namespace SWRevealViewController {
	...
	interface SWRevealViewControllerDelegate {
		...
		void WillAddViewController (SWRevealViewController revealController, UIViewController viewController,  operation, bool animated);
		...
		void DidAddViewController (SWRevealViewController revealController, UIViewController viewController,  operation, bool animated);
		...
		UIViewControllerAnimatedTransitioning AnimationControllerForOperation (SWRevealViewController revealController,  operation, UIViewController fromVC, UIViewController toVC);
